...
<dl>
  <dt>Brand</dt>
<!-- this name prop syntax allows to send good data to the post variable and allow us to retrieve it in a clean more simple way  -->
...
<dl>
  ...
  <dd>
    <select name="bicycle[condition_id]">
      <option value=""></option>
    <?php foreach(Bicycle::CONDTION_OPTIONS as $cond_id => $cond_name) { ?>
